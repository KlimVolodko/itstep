...
//unshift Дан массив [1, 2, 3]. Добавьте ему в начало элементы 4, 5, 6.
console.log(`Задача 4`);
let b2 = b.unshift(4, 5, 6);
console.log(b);
...
//slice: 8. Дан массив [1, 2, 3, 4, 5]. С помощью метода slice запишите в новый элементы [1, 2, 3].
console.log(`Задача 8`);
console.log(v);
let v2 = v.slice(3);
console.log(v2);

//splice:9. Дан массив [1, 2, 3, 4, 5]. С помощью метода splice преобразуйте массив в [1, 4, 5].
